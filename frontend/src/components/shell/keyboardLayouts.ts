...
function buildLayout(): Record<string, KeySpec> {
  ...
  Object.assign(map, {
    ...
    '-': { code: 'Slash' }, '_': { code: 'Slash', shift: true },
    '+': { code: 'BracketRight' }, '*': { code: 'BracketRight', shift: true },
    '#': { code: 'Backslash' }, "'": { code: 'Backslash', shift: true },
    '<': { code: 'IntlBackslash' }, '>': { code: 'IntlBackslash', shift: true },
    ',': { code: 'Comma' }, ';': { code: 'Comma', shift: true },
    '.': { code: 'Period' }, ':': { code: 'Period', shift: true },
    '@': { code: 'KeyQ', altgr: true }, '€': { code: 'KeyE', altgr: true },
    '{': { code: 'Digit7', altgr: true }, '[': { code: 'Digit8', altgr: true },
    ']': { code: 'Digit9', altgr: true }, '}': { code: 'Digit0', altgr: true },
    '\\': { code: 'Minus', altgr: true }, '|': { code: 'IntlBackslash', altgr: true },
    '^': { code: 'Backquote', dead: true },
    '`': { code: 'Equal', shift: true, dead: true },
    '~': { code: 'BracketRight', altgr: true, dead: true },
    'ä': { code: 'Quote' }, 'Ä': { code: 'Quote', shift: true },
    'ö': { code: 'Semicolon' }, 'Ö': { code: 'Semicolon', shift: true },
    'ü': { code: 'BracketLeft' }, 'Ü': { code: 'BracketLeft', shift: true },
    'ß': { code: 'Minus' },
