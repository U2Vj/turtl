...
# This file contains all renderers (encoders) for the REST endpoints
# of the authentication api.
# Renderers are a part of the Django REST Framework Plugin.
# Check out https://www.django-rest-framework.org/api-guide/renderers/
